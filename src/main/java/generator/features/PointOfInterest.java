 ...
 * @author tioannid
 */
public class PointOfInterest implements Serializable {    // Small Hexagon

    // ----- STATIC MEMBERS -----
    static final String className = "PointOfInterest";
    static final String prefix = "http://geographica.di.uoa.gr/generator/pointOfInterest/";
